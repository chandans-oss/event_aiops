...
export const LOVELABLE_REPORT_DATA: LovelableReport = {
  ...
  xcorrR: [
    { a: 'util_pct', b: 'queue_depth', r: 0.6833, s: 0.6234, lag: '-2 polls', interp: 'Buffer Util LEADS B/W Util by 10 min' },
    { a: 'util_pct', b: 'crc_errors', r: 0.6740, s: 0.6421, lag: '-3 polls', interp: 'CRC Errors LEADS B/W Util by 15 min' },
    { a: 'util_pct', b: 'latency_ms', r: 0.6834, s: 0.6212, lag: '-2 polls', interp: 'Latency LEADS B/W Util by 10 min' },
    { a: 'util_pct', b: 'cpu_pct', r: 0.7133, s: 0.6284, lag: '-1 polls', interp: 'CPU Util LEADS B/W Util by 5 min' },
    { a: 'util_pct', b: 'mem_util_pct', r: 0.5183, s: 0.4726, lag: '-4 polls', interp: 'Mem Util LEADS B/W Util by 20 min' },
    { a: 'util_pct', b: 'temp_c', r: 0.5098, s: 0.4634, lag: '-3 polls', interp: 'temp_c LEADS B/W Util by 15 min' },
    { a: 'util_pct', b: 'fan_speed_rpm', r: 0.1691, s: 0.1795, lag: '-1 polls', interp: 'fan_speed_rpm LEADS B/W Util by 5 min' },
    { a: 'util_pct', b: 'power_supply_status', r: 0.0000, s: 0.0000, lag: '+0 polls', interp: 'simultaneous' },
    { a: 'util_pct', b: 'reboot_delta', r: -0.1013, s: -0.1032, lag: '+11 polls', interp: 'B/W Util LEADS reboot_delta by 55 min' },
    { a: 'queue_depth', b: 'crc_errors', r: 0.9319, s: 0.9284, lag: '-1 polls', interp: 'CRC Errors LEADS Buffer Util by 5 min' },
    { a: 'queue_depth', b: 'latency_ms', r: 0.9968, s: 0.9946, lag: '+0 polls', interp: 'simultaneous' },
    { a: 'queue_depth', b: 'cpu_pct', r: 0.8502, s: 0.8221, lag: '+1 polls', interp: 'Buffer Util LEADS CPU Util by 5 min' },
    { a: 'queue_depth', b: 'mem_util_pct', r: 0.6660, s: 0.6472, lag: '-3 polls', interp: 'Mem Util LEADS Buffer Util by 15 min' },
    { a: 'queue_depth', b: 'temp_c', r: 0.6257, s: 0.5967, lag: '-1 polls', interp: 'temp_c LEADS Buffer Util by 5 min' },
    ...
    { a: 'queue_depth', b: 'reboot_delta', r: -0.0948, s: -0.0848, lag: '+9 polls', interp: 'Buffer Util LEADS reboot_delta by 45 min' },
    { a: 'crc_errors', b: 'latency_ms', r: 0.9266, s: 0.9233, lag: '+1 polls', interp: 'CRC Errors LEADS Latency by 5 min' },
    { a: 'crc_errors', b: 'cpu_pct', r: 0.7872, s: 0.7668, lag: '+2 polls', interp: 'CRC Errors LEADS CPU Util by 10 min' },
    { a: 'crc_errors', b: 'mem_util_pct', r: 0.5943, s: 0.5865, lag: '+0 polls', interp: 'simultaneous' },
    { a: 'crc_errors', b: 'temp_c', r: 0.5656, s: 0.5387, lag: '+1 polls', interp: 'CRC Errors LEADS temp_c by 5 min' },
    { a: 'crc_errors', b: 'fan_speed_rpm', r: 0.2177, s: 0.2210, lag: '+1 polls', interp: 'CRC Errors LEADS fan_speed_rpm by 5 min' },
    { a: 'crc_errors', b: 'power_supply_status', r: 0.0000, s: 0.0000, lag: '+0 polls', interp: 'simultaneous' },
    { a: 'crc_errors', b: 'reboot_delta', r: 0.1007, s: 0.1307, lag: '-3 polls', interp: 'reboot_delta LEADS CRC Errors by 15 min' },
    { a: 'latency_ms', b: 'cpu_pct', r: 0.8518, s: 0.8212, lag: '+1 polls', interp: 'Latency LEADS CPU Util by 5 min' },
    { a: 'latency_ms', b: 'mem_util_pct', r: 0.6660, s: 0.6374, lag: '-2 polls', interp: 'Mem Util LEADS Latency by 10 min' },
    { a: 'latency_ms', b: 'temp_c', r: 0.6282, s: 0.5947, lag: '-1 polls', interp: 'temp_c LEADS Latency by 5 min' },
    ...
    { a: 'latency_ms', b: 'reboot_delta', r: -0.0962, s: -0.0911, lag: '+9 polls', interp: 'Latency LEADS reboot_delta by 45 min' },
    { a: 'cpu_pct', b: 'mem_util_pct', r: 0.6931, s: 0.6651, lag: '-4 polls', interp: 'Mem Util LEADS CPU Util by 20 min' },
    { a: 'cpu_pct', b: 'temp_c', r: 0.6919, s: 0.6569, lag: '-1 polls', interp: 'temp_c LEADS CPU Util by 5 min' },
    { a: 'cpu_pct', b: 'fan_speed_rpm', r: 0.1580, s: 0.1748, lag: '-2 polls', interp: 'fan_speed_rpm LEADS CPU Util by 10 min' },
    { a: 'cpu_pct', b: 'power_supply_status', r: 0.0000, s: 0.0000, lag: '+0 polls', interp: 'simultaneous' },
    { a: 'cpu_pct', b: 'reboot_delta', r: 0.1172, s: 0.0712, lag: '-15 polls', interp: 'reboot_delta LEADS CPU Util by 75 min' },
    { a: 'mem_util_pct', b: 'temp_c', r: 0.5608, s: 0.5255, lag: '+2 polls', interp: 'Mem Util LEADS temp_c by 10 min' },
    ...
    { a: 'mem_util_pct', b: 'reboot_delta', r: 0.1442, s: 0.1301, lag: '-14 polls', interp: 'reboot_delta LEADS Mem Util by 70 min' },
  ...
  xcorrT: [
    ...
    { a: 'R1:cpu_pct', b: 'FW1:latency_ms', r: 0.809, s: 0.78, lag: '-7 polls', interp: 'router CPU Util spike → firewall Latency 35min later' },
    { a: 'R1:cpu_pct', b: 'SW2:buffer_util', r: 0.775, s: 0.74, lag: '-5 polls', interp: 'CPU Util spike → Buffer fills 25min later' },
    { a: 'SW1:crc_errors', b: 'FW1:latency_ms', r: 0.758, s: 0.72, lag: '-5 polls', interp: 'CRC Errors at SW1 → Latency at FW1 25min later' },
  ],
  xcorrS: [
    { a: 'util_pct', b: 'queue_depth', r: 0.8218, s: 0.7764, lag: '-1 polls', interp: 'Buffer Util LEADS B/W Util by 5 min' },
    { a: 'util_pct', b: 'crc_errors', r: 0.7701, s: 0.7115, lag: '-2 polls', interp: 'CRC Errors LEADS B/W Util by 10 min' },
    { a: 'util_pct', b: 'latency_ms', r: 0.8136, s: 0.7609, lag: '-1 polls', interp: 'Latency LEADS B/W Util by 5 min' },
    { a: 'util_pct', b: 'cpu_pct', r: 0.7745, s: 0.7337, lag: '+0 polls', interp: 'simultaneous' },
    { a: 'util_pct', b: 'mem_util_pct', r: 0.1789, s: 0.1639, lag: '+3 polls', interp: 'B/W Util LEADS Mem Util by 15 min' },
    { a: 'util_pct', b: 'temp_c', r: 0.3306, s: 0.3076, lag: '-4 polls', interp: 'temp_c LEADS B/W Util by 20 min' },
    { a: 'util_pct', b: 'fan_speed_rpm', r: -0.1051, s: -0.1133, lag: '+6 polls', interp: 'B/W Util LEADS fan_speed_rpm by 30 min' },
    { a: 'util_pct', b: 'power_supply_status', r: 0.0000, s: 0.0000, lag: '+0 polls', interp: 'simultaneous' },
    { a: 'util_pct', b: 'reboot_delta', r: 0.0000, s: 0.0000, lag: '+0 polls', interp: 'simultaneous' },
    { a: 'queue_depth', b: 'crc_errors', r: 0.9229, s: 0.9128, lag: '-1 polls', interp: 'CRC Errors LEADS Buffer Util by 5 min' },
    { a: 'queue_depth', b: 'latency_ms', r: 0.9970, s: 0.9946, lag: '+0 polls', interp: 'simultaneous' },
    { a: 'queue_depth', b: 'cpu_pct', r: 0.8704, s: 0.8357, lag: '+1 polls', interp: 'Buffer Util LEADS CPU Util by 5 min' },
    { a: 'queue_depth', b: 'mem_util_pct', r: 0.1283, s: 0.1056, lag: '+4 polls', interp: 'Buffer Util LEADS Mem Util by 20 min' },
    { a: 'queue_depth', b: 'temp_c', r: 0.4010, s: 0.4108, lag: '-3 polls', interp: 'temp_c LEADS Buffer Util by 15 min' },
    { a: 'queue_depth', b: 'fan_speed_rpm', r: -0.1257, s: -0.1427, lag: '+7 polls', interp: 'Buffer Util LEADS fan_speed_rpm by 35 min' },
    { a: 'queue_depth', b: 'power_supply_status', r: 0.0000, s: 0.0000, lag: '+0 polls', interp: 'simultaneous' },
    { a: 'queue_depth', b: 'reboot_delta', r: 0.0000, s: 0.0000, lag: '+0 polls', interp: 'simultaneous' },
    { a: 'crc_errors', b: 'latency_ms', r: 0.9212, s: 0.9060, lag: '+1 polls', interp: 'CRC Errors LEADS Latency by 5 min' },
    { a: 'crc_errors', b: 'cpu_pct', r: 0.8009, s: 0.7577, lag: '+2 polls', interp: 'CRC Errors LEADS CPU Util by 10 min' },
    { a: 'crc_errors', b: 'mem_util_pct', r: 0.1470, s: 0.0952, lag: '-1 polls', interp: 'Mem Util LEADS CRC Errors by 5 min' },
    { a: 'crc_errors', b: 'temp_c', r: 0.3676, s: 0.3779, lag: '-2 polls', interp: 'temp_c LEADS CRC Errors by 10 min' },
    { a: 'crc_errors', b: 'fan_speed_rpm', r: -0.1020, s: -0.1376, lag: '+7 polls', interp: 'CRC Errors LEADS fan_speed_rpm by 35 min' },
    { a: 'crc_errors', b: 'power_supply_status', r: 0.0000, s: 0.0000, lag: '+0 polls', interp: 'simultaneous' },
    { a: 'crc_errors', b: 'reboot_delta', r: 0.0000, s: 0.0000, lag: '+0 polls', interp: 'simultaneous' },
    { a: 'latency_ms', b: 'cpu_pct', r: 0.8704, s: 0.8384, lag: '+1 polls', interp: 'Latency LEADS CPU Util by 5 min' },
    { a: 'latency_ms', b: 'mem_util_pct', r: 0.1279, s: 0.1025, lag: '+4 polls', interp: 'Latency LEADS Mem Util by 20 min' },
    { a: 'latency_ms', b: 'temp_c', r: 0.3990, s: 0.4092, lag: '-3 polls', interp: 'temp_c LEADS Latency by 15 min' },
    { a: 'latency_ms', b: 'fan_speed_rpm', r: -0.1125, s: -0.1271, lag: '+7 polls', interp: 'Latency LEADS fan_speed_rpm by 35 min' },
    { a: 'latency_ms', b: 'power_supply_status', r: 0.0000, s: 0.0000, lag: '+0 polls', interp: 'simultaneous' },
    { a: 'latency_ms', b: 'reboot_delta', r: 0.0000, s: 0.0000, lag: '+0 polls', interp: 'simultaneous' },
    { a: 'cpu_pct', b: 'mem_util_pct', r: 0.1257, s: 0.0909, lag: '+3 polls', interp: 'CPU Util LEADS Mem Util by 15 min' },
    { a: 'cpu_pct', b: 'temp_c', r: 0.3849, s: 0.3678, lag: '-3 polls', interp: 'temp_c LEADS CPU Util by 15 min' },
    { a: 'cpu_pct', b: 'fan_speed_rpm', r: -0.1166, s: -0.1075, lag: '+6 polls', interp: 'CPU Util LEADS fan_speed_rpm by 30 min' },
    { a: 'cpu_pct', b: 'power_supply_status', r: 0.0000, s: 0.0000, lag: '+0 polls', interp: 'simultaneous' },
    { a: 'cpu_pct', b: 'reboot_delta', r: 0.0000, s: 0.0000, lag: '+0 polls', interp: 'simultaneous' },
    { a: 'mem_util_pct', b: 'temp_c', r: 0.1501, s: 0.1332, lag: '-4 polls', interp: 'temp_c LEADS Mem Util by 20 min' },
    { a: 'mem_util_pct', b: 'fan_speed_rpm', r: -0.1811, s: -0.1548, lag: '-15 polls', interp: 'fan_speed_rpm LEADS Mem Util by 75 min' },
    { a: 'mem_util_pct', b: 'power_supply_status', r: 0.0000, s: 0.0000, lag: '+0 polls', interp: 'simultaneous' },
