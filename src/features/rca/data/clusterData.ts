...
export const CLU_LC_001_Causes: ProbableCause[] = [
    {
        ...
        description: 'High utilization and queue drops correlated with scheduled backup traffic.',
        confidence: 0.95,
        severity: 'Major',
        tags: ['Pattern Match', 'High Confidence']
    },
    {
        id: 'RCA-LC-001-B',
        title: 'Microburst Traffic',
        description: 'Short-duration high-intensity traffic bursts causing buffer exhaustion.',
        confidence: 0.65,
        severity: 'Major',
        tags: ['Heuristic']
    },
    {
        ...
        description: 'Potential duplex mismatch causing late collisions and drops.',
        confidence: 0.35,
        severity: 'Minor',
        tags: ['Low Confidence']
    }
...
export const getProbableCauses = (clusterId: string): ProbableCause[] => {
    if (clusterId === 'CLU-LC-001') return CLU_LC_001_Causes;
    // Default causes for others
    return [
        { id: `${clusterId}-RCA-01`, title: 'Primary Root Cause', description: 'Most likely cause based on available evidence.', confidence: 0.88, severity: 'Critical', tags: ['AI Prediction'] },
        { id: `${clusterId}-RCA-02`, title: 'Secondary Hypothesis', description: 'Alternative explanation with lower probability.', confidence: 0.45, severity: 'Major', tags: ['Heuristic'] },
        { id: `${clusterId}-RCA-03`, title: 'Transient Anomaly', description: 'Possible transient issue that self-corrected.', confidence: 0.20, severity: 'Minor' }
    ];
};
