  ...
  routers: [
    {
      ...
      event: "HIGH_LATENCY",
      details: [
        { metric: "cpu_pct", trend: "increase" },
        { metric: "crc_errors", trend: "increase" },
        { metric: "queue_depth", trend: "increase" },
        { metric: "latency_ms", trend: "increase" },
        { metric: "util_pct", trend: "increase" }
      ],
      date: "Mar 10, 2026",
      confidence: 0.98,
      occurrences: 231,
  ...
  switches: [
    {
      ...
      event: "DEVICE_REBOOT",
      details: [
        { metric: "queue_depth", trend: "decrease" },
        { metric: "crc_errors", trend: "decrease" },
        { metric: "latency_ms", trend: "decrease" },
        { metric: "util_pct", trend: "decrease" },
        { metric: "cpu_pct", trend: "decrease" }
      ],
      date: "Mar 05, 2026",
      confidence: 0.88,
      occurrences: 2,
    ...
    },
    {
      ...
      details: [
        ...
        { metric: "queue_depth", trend: "increase" },
        { metric: "latency_ms", trend: "increase" },
        { metric: "reboot_delta", trend: "increase" },
        { metric: "util_pct", trend: "increase" }
      ],
      date: "Mar 10, 2026",
      confidence: 0.91,
    ...
    <MainLayout>
      <div className="p-8 space-y-8 animate-in fade-in duration-500">
        <div className="flex items-center justify-between border-b pb-6 mb-8">
          <div>
            <h1 className="text-2xl font-bold tracking-tight">PatternWorkspace</h1>
                ...
                <SheetHeader className="p-6 border-b border-border/50">
                  <div className="flex items-center justify-between">
                    <SheetTitle className="text-xl font-bold tracking-tight flex items-center gap-3">
                      ...
                      AnalysisWorkspace — <span className="text-primary capitalize">GlobalPatterns</span>
                    </SheetTitle>
                  </div>
                </SheetHeader>
            ...
            <table className="w-full text-left border-collapse min-w-[1200px]">
              <thead>
                <tr className="border-b border-border bg-muted/20">
                  <th className="px-6 py-4 text-[10px] font-bold uppercase tracking-wider text-muted-foreground w-[220px]">PatternName</th>
                  <th className="px-6 py-4 text-[10px] font-bold uppercase tracking-wider text-muted-foreground">Details</th>
                  <th className="px-6 py-4 text-[10px] font-bold uppercase tracking-wider text-muted-foreground w-[180px]">RuleCreationDate</th>
                  ...
                  <th className="px-6 py-4 text-[10px] font-bold uppercase tracking-wider text-muted-foreground w-[150px]">LastSeen</th>
