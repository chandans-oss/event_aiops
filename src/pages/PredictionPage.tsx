...
const PREDICTION_DATA = {
  routers: [
    { device: "router-03", interface: "Gi0/3/0", predicted_event: "PACKET_DROP", probability: 87.4, severity: "critical", predicted_time: "2026-03-14 10:15:00" },
    { device: "router-02", interface: "Gi0/1/0", predicted_event: "INTERFACE_FLAP", probability: 81.2, severity: "warning", predicted_time: "2026-03-14 09:45:00" },
    { device: "router-01", interface: "Gi0/2/0", predicted_event: "HIGH_UTIL_WARNING", probability: 84.6, severity: "warning", predicted_time: "2026-03-14 11:20:00" },
    { device: "router-04", interface: "Gi0/3/0", predicted_event: "HIGH_LATENCY", probability: 78.9, severity: "info", predicted_time: "2026-03-14 08:30:00" },
    { device: "router-05", interface: "Gi0/2/0", predicted_event: "PACKET_DROP", probability: 82.7, severity: "critical", predicted_time: "2026-03-14 12:10:00" }
  ],
  switches: [
    { device: "switch-03", interface: "Eth1/3", predicted_event: "INTERFACE_FLAP", probability: 79.5, severity: "warning", predicted_time: "2026-03-14 10:05:00" },
    { device: "switch-02", interface: "Eth1/1", predicted_event: "PACKET_DROP", probability: 85.3, severity: "critical", predicted_time: "2026-03-14 09:15:00" },
    { device: "switch-01", interface: "Eth1/2", predicted_event: "HIGH_UTIL_WARNING", probability: 83.8, severity: "warning", predicted_time: "2026-03-14 11:40:00" },
    { device: "switch-04", interface: "Eth1/1", predicted_event: "PACKET_DROP", probability: 80.4, severity: "critical", predicted_time: "2026-03-14 08:50:00" },
    { device: "switch-02", interface: "Eth1/3", predicted_event: "INTERFACE_FLAP", probability: 77.6, severity: "warning", predicted_time: "2026-03-14 12:55:00" }
  ]
};
            ...
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="border-b border-border bg-muted/20">
                  <th className="px-6 py-4 text-[11px] font-bold uppercase tracking-wider text-muted-foreground w-[220px]">Device and Interface</th>
                  ...
                  <th className="px-6 py-4 text-[11px] font-bold uppercase tracking-wider text-muted-foreground w-[180px]">Probability Percentage</th>
                </tr>
              </thead>
            </table>
          </div>
                  ...
                  <tr key={idx} className="hover:bg-muted/5 transition-colors group">
                    <td className="px-6 py-5 w-[220px]">
                      <div className="flex flex-col gap-1">
                        <span className="text-[11px] font-bold text-foreground group-hover:text-primary transition-colors uppercase tracking-widest">{item.device}</span>
                        <span className="text-[9px] text-muted-foreground font-mono">{item.interface}</span>
                      </div>
                    </td>
                    ...
                    <td className="px-6 py-5 w-[180px]">
                      <span className="text-[11px] font-black tabular-nums text-foreground/80">{item.predicted_time}</span>
                    </td>
                    <td className="px-6 py-5 w-[180px]">
                      <div className="flex items-center gap-4">
